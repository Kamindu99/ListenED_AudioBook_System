        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav  mb-2 mb-lg-0 ms-auto" style={{ marginRight: '5%' }}>
            <li className="nav-item">
              <a className={`nav-link nav-link-a-text me-3 ${isHome ? 'active' : ''}`} href="/">ප්‍රධාන පිටුව</a>
            </li>

            <li className="nav-item">
              <a href='/books-home' className={`nav-link me-3 nav-link-a-text ${isalltrains ? 'active' : ''}`}>Audio පොත්</a>
            </li>

            <li className="nav-item">
              <a href='/search' className={`nav-link me-3 nav-link-a-text ${issearch ? 'active' : ''}`}>සොයන්න</a>
            </li>

            <li className="nav-item" >
              <a href='/recommendations' className={`nav-link me-3 nav-link-a-text ${ismybookings ? 'active' : ''}`}>නිර්දේශයන්</a>
            </li>

            <li className="nav-item">
              <a className={`nav-link nav-link-a-text me-3 ${isQuiz ? 'active' : ''}`} href="/quiz" >ප්‍රශ්නාවලිය</a>
            </li>

            <li className="nav-item">
              <a className={`nav-link nav-link-a-text me-3 ${isAboutUs ? 'active' : ''}`} href="/about" >අපි ගැන</a>
            </li>
